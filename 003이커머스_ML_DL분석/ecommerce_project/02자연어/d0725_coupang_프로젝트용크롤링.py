...
# 파일 저장
f = open('/Users/hyeonchanglee/Downloads/'+datetime.now().strftime('%Y-%m-%d_%H%M')+'re.csv','w',encoding='utf-8-sig',newline="")
writer = csv.writer(f)
...
url = 'https://www.coupang.com/np/products/brand-shop?brandName=Apple' #애플 브랜드관
...
for i,item in enumerate(items):
    ...
    def digger():
        ...
        for j,box in enumerate(boxes):
            ...
            review_content = box.find('div',{'class':'sdp-review__article__list__review__content'}).get_text().strip() #내부 댓글을 확인
